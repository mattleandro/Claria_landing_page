...
const resources = {
  pt: {
    translation: {
      ...
      "contactMessagePlaceholder": "Olá, gostaria de fazer uma parceria (mensagem exemplo)",
  ...
  en: {
    translation: {
      ...
      "contactMessagePlaceholder": "Hello, I would like to propose a partnership (example message)",
