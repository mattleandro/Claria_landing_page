...
import styles from './Music.module.css'; // Importa o CSS Module
import clariaViolao from '../../assets/claria_violao.jpg'; // Caminho para sua imagem
    ...
    <section id={id} className={`container ${styles['music-section']}`}>
      ...
      <div className={styles['highlight-music']}>
        ...
        <div className={styles['highlight-text']}>
          ...
          <a href="https://open.spotify.com/intl-pt/album/7sNlDAVnqTf44AsqzYvGc0" target="_blank" className={`${styles.btn} ${styles['secondary-btn']}`}>
            Ouça '21' Agora {/* */}
          </a>
        </div>
      </div>
