  ...
  return (
    <section id={id} className={`container ${styles['contact-section']}`}>
      ...
      <div className={styles['social-links']}>
        ...
        {/* Youtube Icon */}
        <a href="http://youtube.com/your-youtube-channel" target="_blank" rel="noopener noreferrer" className={styles['icon-item']} aria-label={t('contactYoutubeAria')}>
          <div className={styles['icon-wrapper']}>
            <svg viewBox="0 0 24 24" className={styles['social-icon']}>
        ...
        {/* Spotify Icon */}
        <a href="https://open.spotify.com/intl-pt/album/7sNlDAVnqTf44AsqzYvGc0" target="_blank" rel="noopener noreferrer" className={styles['icon-item']} aria-label={t('contactSpotifyAria')}>
          <div className={styles['icon-wrapper']}>
            <svg viewBox="0 0 24 24" className={styles['social-icon']}>
        ...
        {/* Hyperddit Icon */}
        <a href="https://hypeddit.com/jc5rhf" target="_blank" rel="noopener noreferrer" className={styles['icon-item']} aria-label={t('contactHyperdditAria')}>
          <div className={styles['icon-wrapper']}>
            <svg viewBox="0 0 24 24" className={styles['social-icon']}>
