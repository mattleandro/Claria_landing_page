...
import '../../index.css'; // Importa o CSS global para variáveis e classes base como 'container'
  ...
  return (
    <section id={id} className={`container ${styles['contact-section']}`}>
      ...
      <form className={styles['contact-form']} onSubmit={handleSubmit}>
        ...
        {/* Aplica a classe 'primary-btn' do CSS Module */}
      ...
      <div className={styles['social-links']}>
        ...
        <a href="https://www.instagram.com/aclariclaria" target="_blank" rel="noopener noreferrer" className={styles['icon-item']} aria-label="Instagram da Clariá">
          <div className={styles['icon-wrapper']}>
            <svg viewBox="0 0 24 24" className={styles['social-icon']}> {/* Usei social-icon para generalizar o estilo do SVG */}
        ...
        {/* Youtube Icon */}
        <a href="http://youtube.com/your-youtube-channel" target="_blank" rel="noopener noreferrer" className={styles['icon-item']} aria-label="Youtube da Clariá">
          <div className={styles['icon-wrapper']}>
            <svg viewBox="0 0 24 24" className={styles['social-icon']}>
